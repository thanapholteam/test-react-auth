        ...
        <div className="w-full p-6 bg-white rounded-lg shadow border md:mt-0 sm:max-w-md sm:p-8 animate-fade-up">
          ...
          <form onSubmit={(e) => handleRegister(e)}>
            ...
            <div className="flex items-baseline justify-center my-1">
              <button
                className="w-full py-2 mt-4 text-white font-semibold bg-emerald-600 rounded-lg hover:bg-emerald-700 disabled:opacity-40 hover:text-white transition ease-linear duration-200"
                disabled={
                  !errPassword ||
                  confirmPass !== regisForm.password ||
                  !errEmail
